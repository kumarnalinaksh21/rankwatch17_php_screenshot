...
Please ensure you are saving a JPG or PNG image only."<br></br> </p>
          ...
          <div class="subcription-info text-center">
            ...
            <p class="sub-p">Pease check below for screenshots:.</p> page will refresh and the image will appear below this point.
                                                                     rightclick + save to save the pic in jpeg.
          </div>
        </div>
      </div>
    ...
    <footer class="footer">
      <div class="container">
         <div class="row bort">
           ...
           <h1>
           Hope the project was to your liking :)
           </h1>
         </div>
      </div>
    </footer>
